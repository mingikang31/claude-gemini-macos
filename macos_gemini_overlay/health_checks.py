...
def get_log_dir():
    ...
    log_dir = Path.home() / "Library" / "Logs" / "macos-ai-assistant-overlay"
...
LOG_DIR = get_log_dir()
LOG_PATH = LOG_DIR / "macos_ai_assistant_overlay_error_log.txt"
CRASH_COUNTER_FILE = LOG_DIR / "macos_ai_assistant_overlay_crash_counter.txt"
